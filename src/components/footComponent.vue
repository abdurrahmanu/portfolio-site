<template>
    <div class="md:bg-[url('../public/white-with-black-crack.png')] dark:md:bg-[url('../public/black-with-white-crack.png')] dark:bg-neutral-900 bg-white relative">
        <div class="w-full p-1 sm:p-4 z-[9] relative">
            <div class="grid p-4">
                ...
                <div class="py-2">
                    <div @click.prevent="submit" class="p-[2px] bg-black w-fit m-auto rounded-full">
                        <button @click="downloadResume" class="rounded-full text-white bg-black md:px-28 p-3 hover:text-white px-16 uppercase text-sm flex items-center gap-2">
                            SUBMIT
                        </button>
                    </div>
                </div>
